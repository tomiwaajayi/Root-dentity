                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <p class="text-info-1">The places your ancestors called home are encoded in your Physical
                            ...
                            historically
                            come from the same geographic regions and draw from a local gene pool. <strong>The app analyzes your
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row feature-box feature-1">
                        ...
                        <p>With precise geographic detail and clear-cut historical insights, we connect you to the places in the world where your story started.</p>
                    </div>
                    ...
                    <div class="row feature-box feature-3">
                        <h3>Root-dentity® gives you 3D-simulations/life-like imageries of what your ancestors look like. </h3>
                        <p>With precise geographic detail and clear-cut historical insights, we connect you to the places in the world where your story started.</p>
                    </div>
                </div>
            </div>
